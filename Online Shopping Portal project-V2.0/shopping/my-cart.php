...
// This block handles order placement using MySQL only
// Blockchain is not involved here to avoid performance delay
<html lang="en">
...
<head>
	...
	<!-- Gmart Theme (MUST be LAST) -->
	<link rel="stylesheet" href="assets/css/gmart-theme.css">
